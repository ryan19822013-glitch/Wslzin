...
Bota a proxy aqui pae
$proxies = [
    "Bota a proxy aqui pae"
];

$selectedProxy = $proxies[array_rand($proxies)];
$proxyParts = explode(':', $selectedProxy);
$proxyHostPort = $proxyParts[0] . ':' . $proxyParts[1];
...
function httpRequest($url, $method = 'GET', $data = null, $headers = [], $proxyHostPort = null, $proxyUserPwd = null) {
    $ch = curl_init();
...
try {
    ...
    $checkoutResp = httpRequest($checkoutUrl, 'POST', $paymentData, $checkoutHeaders, $proxyHostPort, $proxyUserPwd);
